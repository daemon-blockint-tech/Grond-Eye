/**
 * @file index.ts
 * @description Core SDK for Grond plugin development.
...
export interface PluginContext {
     ...
     * The engine surfaces any variable starting with NEXT_PUBLIC_GROND_PLUGIN_
     * 
    ...
    /** The running edition of the Grond engine */
 ...
 * @description The core lifecycle interface for all Grond extensions.
...
// Vite/build-only helpers (fs, etc.) — import from "@grond/plugin-sdk/vite"
