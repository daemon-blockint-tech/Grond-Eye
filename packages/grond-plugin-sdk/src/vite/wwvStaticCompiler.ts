 ...
 *
 * If the plugin's package.json has `grond.format: "static"` and
 ...
 */
export function grondStaticCompiler(): any {
    let pluginRoot = "";
    let manifest: any = null;
    let generatedEntry = "";

    return {
        name: "grond-static-compiler",
        ...
        config(userConfig: any) {
            ...
            manifest = pkg.grond || pkg.worldwideview || null;
            if (!manifest) return;
...
import { createSvgIconUrl } from "@grond/plugin-sdk";
