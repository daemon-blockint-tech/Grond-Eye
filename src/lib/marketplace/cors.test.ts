...
describe("CORS utility", () => {
    describe("corsHeaders", () => {
        ...
        it("returns production origin when matched", () => {
            const headers = corsHeaders(fakeRequest("https://marketplace.maven-system.dev"));
            expect(headers["Access-Control-Allow-Origin"]).toBe("https://marketplace.maven-system.dev");
        });
